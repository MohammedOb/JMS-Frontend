...
export default function WABulkModal({ open, onClose, rows = [], batchLabel = 'Takhmeen Reminder' }) {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Write your message using {FullName}, {ForYear} etc."
            />
