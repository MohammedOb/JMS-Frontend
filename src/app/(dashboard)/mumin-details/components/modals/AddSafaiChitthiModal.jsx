...
export default function AddSafaiChitthiModal({
  open, onClose,
  member, accNo,
  form, set,
  saving, onSave,
  ...
  return (
    <Modal
      open={open}
      onClose={onClose}
      title={`Add Safai Chitthi — ${member?.name || member?.FullName || ''} (Acc# ${accNo})`}
      size="lg"
      footer={
        <>
      ...
      <div className="space-y-4 text-[13px]">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            <InfoChip label="Full Name" value={form.FullName} />
            <InfoChip label="ITS No" value={form.ITSNo} />
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input className="form-input" value={form.Requestby}
                onChange={e => set('Requestby', e.target.value)} placeholder="Name of requester" />
            </div>
            <div>
              <label className="form-label">Created By</label>
              <input className="form-input bg-gray-50 text-gray-500" value={form.Createdby} readOnly
