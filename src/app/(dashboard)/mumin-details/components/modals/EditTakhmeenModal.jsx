        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select className="form-select" value={editTakRow.mainHead || ''}
            ...
            <div>
              ...
              <select className="form-select" value={editTakRow.subHead || ''}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input className="form-input" value={editTakRow.forYear || ''}
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <input type="number" className="form-input" value={editTakRow.takhmeen || ''}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="date" className="form-input" value={editTakRow.date || ''}
